...
- [ ] **Step 3：实现 Pinning TrustManager**
...
- [ ] **Step 4：限制 Bearer Token 发送范围**

专用 Interceptor 在每个请求前比较 scheme、host 和有效端口，仅完全匹配草稿/已验证 URL 时添加 `Authorization: Bearer ...`。不使用 Authenticator，401 不重试；禁止自动 Redirect，避免跨 Host 泄露。
...
- [ ] **Step 4：保持 SpamNumberRepository 超时与 Fail Open**
...
- [ ] **Step 5：更新 ViewModel 的 source 状态消费**
...
- [ ] **Step 4：在 UI 与 Receiver 增加第二道门禁**
